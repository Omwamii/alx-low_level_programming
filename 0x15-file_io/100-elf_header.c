...
/**
  ...
  *@e_ident: array of specifications
  */
...
/**
  *print_magic - prints the magic number in the elf
  *@e_ident: array of specifications
  */
...
/**
  ...
  *@e_ident: array containing ebi version
  */
void print_abi(unsigned char *e_ident)
{
...
/**
  ...
  *@e_type: type variable in header
  *@e_ident: array of specifications
  */
...
/**
 * main - Displays elf header contents
